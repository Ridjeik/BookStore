    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TitleBooks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookInfos_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookInfos_Pictures_PictureId",
                        column: x => x.PictureId,
                        principalTable: "Pictures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookInfos_Publishers_PublisherId",
                        column: x => x.PublisherId,
                        principalTable: "Publishers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookInfos_TitleBooks_TitleId",
                        column: x => x.TitleId,
                        principalTable: "TitleBooks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShelfGenres", x => new { x.ShelfId, x.GenreId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookGenres", x => new { x.BookInfoId, x.GenreId });
                    table.ForeignKey(
                        name: "FK_BookGenres_BookInfos_BookInfoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookInfos_PictureId",
                table: "BookInfos",
                column: "PictureId");

            migrationBuilder.CreateIndex(
                name: "IX_BookInfos_PublisherId",
                table: "BookInfos",
                column: "PublisherId");

            migrationBuilder.CreateIndex(
                name: "IX_BookInfos_TitleId",
                table: "BookInfos",
                column: "TitleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShelfGenres_GenreId",
                table: "ShelfGenres",
                column: "GenreId");

            migrationBuilder.CreateIndex(
                name: "IX_Shelfs_RoomId",
                table: "Shelfs",
                column: "RoomId");
        }
